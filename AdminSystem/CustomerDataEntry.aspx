...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblError" runat="server" height="19px" style="z-index: 1; left: 13px; top: 392px; position: absolute" width="113px"></asp:Label>
        <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click1" style="z-index: 1; left: 28px; top: 439px; position: absolute" Text="OK" />
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 194px; top: 440px; position: absolute" Text="Cancel" />
        ...
        <asp:TextBox ID="txtCustomerEmailAddress" runat="server" style="z-index: 1; left: 166px; top: 112px; position: absolute"></asp:TextBox>
    </form>
</body>
</html>
