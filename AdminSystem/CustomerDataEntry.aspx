...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtCustomerNo" runat="server" style="z-index: 1; left: 135px; top: 34px; position: absolute; right: 437px" height="22px"></asp:TextBox>
        <p>
        ...
        <asp:TextBox ID="txtCustomerName" runat="server" style="z-index: 1; left: 136px; top: 91px; position: absolute" height="22px"></asp:TextBox>
        <p>
            &nbsp;</p>
        <p>
        ...
        <p>
            ...
            <asp:TextBox ID="txtCustomerAddress" runat="server" style="z-index: 1; left: 136px; top: 144px; position: absolute" height="22px"></asp:TextBox>
        </p>
        <p>
            &nbsp;</p>
        <p>
            ...
            <asp:TextBox ID="txtCustomerCardNo" runat="server" style="z-index: 1; left: 136px; top: 206px; position: absolute" height="22px"></asp:TextBox>
        </p>
        <p>
            &nbsp;</p>
        <p>
            ...
            <asp:TextBox ID="txtCustomerCVC" runat="server" style="z-index: 1; left: 136px; top: 309px; position: absolute"></asp:TextBox>
        </p>
        <p>
        ...
        <p>
            <asp:TextBox ID="txtCustomerJoinDate" runat="server" style="z-index: 1; left: 136px; top: 359px; position: absolute" height="22px"></asp:TextBox>
            <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 73px; top: 513px; position: absolute" Text="Cancel" />
        </p>
        <p>
            <asp:CheckBox ID="chkActive" runat="server" style="z-index: 1; left: 10px; top: 417px; position: absolute" Text="Active" height="19px" />
        </p>
        <asp:TextBox ID="txtCustomerExpiryDate" runat="server" style="z-index: 1; left: 136px; top: 261px; position: absolute" height="22px"></asp:TextBox>
