...
<body>
     ...
     <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" style="z-index: 1; left: 259px; top: 615px; position: absolute" Text="Delete" />
     <asp:ListBox ID="lstStaffList" runat="server" Height="591px" Width="629px"></asp:ListBox>
     <p>
         <asp:Button ID="btnAdd" runat="server" OnClick="Button1_Click" Text="Add" />
         <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 13px; top: 716px; position: absolute" Text="Enter your Role"></asp:Label>
     </p>
     <p>
         &nbsp;</p>
     <p>
         <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 138px; top: 615px; position: absolute" Text="Edit" OnClick="btnEdit_Click" />
